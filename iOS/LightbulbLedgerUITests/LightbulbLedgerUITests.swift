...
final class LightbulbLedgerUITests: XCTestCase {
    ...
    func testAddFlowShowsNewItem() throws {
        ...
        nameField.tap()
        nameField.typeText("New Test Fixture")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["New Test Fixture"].waitForExistence(timeout: 2))
    }
